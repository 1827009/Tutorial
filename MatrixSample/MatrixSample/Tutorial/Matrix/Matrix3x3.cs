...
namespace MatrixSample.Tutorial.Matrix
{
    struct Matrix3x3
    {
        ...
        private static Matrix3x3 identity = new Matrix3x3(1f, 0f, 0f,
                                                         0f, 1f, 0f,
                                                         0f, 0f, 1f);
        public Matrix3x3 Identity { get { return identity; } }
        ...
        public static Matrix3x3 Add(Matrix3x3 matrix1, Matrix3x3 matrix2)
        {
            ...
            output.M12 = matrix1.M11 + matrix2.M12;
            output.M13 = matrix1.M11 + matrix2.M13;
            output.M21 = matrix1.M11 + matrix2.M21;
            output.M22 = matrix1.M11 + matrix2.M22;
            output.M23 = matrix1.M11 + matrix2.M23;
            output.M31 = matrix1.M11 + matrix2.M31;
            output.M32 = matrix1.M11 + matrix2.M32;
            output.M33 = matrix1.M11 + matrix2.M33;
            return output;
        }
